...
_TRAINERSPEC = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'sentencepiece.TrainerSpec.differential_privacy_noise_level',
            index=8,
            number=51,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name=
            'sentencepiece.TrainerSpec.differential_privacy_clipping_threshold',
            index=9,
            number=52,
            type=4,
            cpp_type=4,
...
_MODELPROTO_SENTENCEPIECE.fields_by_name[
    'type'].enum_type = _MODELPROTO_SENTENCEPIECE_TYPE
