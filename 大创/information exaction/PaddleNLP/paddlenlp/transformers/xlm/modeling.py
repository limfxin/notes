...
class XLMPretrainedModel(PretrainedModel):
    ...
    pretrained_resource_files_map = {
        "model_state": {
            ...
            'xlm-mlm-ende-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-ende-1024/model_state.pdparams',
            'xlm-mlm-enfr-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-enfr-1024/model_state.pdparams',
            'xlm-mlm-enro-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-enro-1024/model_state.pdparams',
            'xlm-mlm-tlm-xnli15-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-tlm-xnli15-1024/model_state.pdparams',
            'xlm-mlm-xnli15-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-xnli15-1024/model_state.pdparams',
            'xlm-clm-enfr-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-clm-enfr-1024/model_state.pdparams',
            'xlm-clm-ende-1024':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-clm-ende-1024/model_state.pdparams',
            'xlm-mlm-17-1280':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-17-1280/model_state.pdparams',
            'xlm-mlm-100-1280':
            'https://bj.bcebos.com/paddlenlp/models/transformers/xlm/xlm-mlm-100-1280/model_state.pdparams'
        }
    }
...
class XLMWithLMHeadModel(XLMPretrainedModel):
    ...
    def forward(self,
        ...
        """
        xlm_outputs = self.xlm(input_ids,
                               langs=langs,
...
class XLMForSequenceClassification(XLMPretrainedModel):
    ...
    def forward(self,
        ...
        sequence_output = self.xlm(input_ids,
                                   langs=langs,
                                   attention_mask=attention_mask,
                                   position_ids=position_ids,
                                   lengths=lengths)[0]
