...
class ErnieTinyBenchmark(BenchmarkBase):
    ...
    def add_args(args, parser):
        parser.add_argument('--model_name_or_path',
                            type=str,
                            default="ernie-tiny",
                            help='Model name. Defaults to ernie-tiny. ')
        parser.add_argument(
            "--task_name",
            default="tnews",
            type=str,
            help=
            "The name of the task to train selected in the list: afqmc, tnews, iflytek, ocnli, cmnli, cluewsc2020, csl"
        )
    ...
    def build_model(self, args, **kwargs):
        ...
        ) if self.label_list else nn.MSELoss()
