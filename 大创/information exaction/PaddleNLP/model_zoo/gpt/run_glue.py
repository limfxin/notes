...
from paddlenlp.transformers import GPTForSequenceClassification, GPTTokenizer, LinearDecayWithWarmup
...
def convert_example(example,
    ...
    if not is_test:
        return example['input_ids'], label
    else:
...
def do_train(args):
    ...
    batchify_fn = lambda samples, fn=Tuple(
        Pad(axis=0, pad_val=padding_id),  # input
